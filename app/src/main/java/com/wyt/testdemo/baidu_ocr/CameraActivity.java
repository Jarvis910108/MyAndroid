...
import com.wyt.testdemo.baidu_ocr.view.CropView;
import com.wyt.testdemo.baidu_ocr.view.FrameOverlayView;
    ...
    private void initParams() {
        ...
        switch (contentType) {
            ...
            case CONTENT_TYPE_BANK_CARD:
                ...
                overlayView.setVisibility(View.INVISIBLE);
                break;
            case CONTENT_TYPE_GENERAL://普通文字識別
            default:
                maskType = MaskView.MASK_TYPE_NONE;//默認type == 0
                //裁剪视图
                cropMaskView.setVisibility(View.INVISIBLE);
                break;
        }
        cameraView.setMaskType(maskType);
        //如果crop是  none的话 那么就不会做进一步的处理
